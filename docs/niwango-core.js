/*!
  niwango-core.js v0.0.2-canary.20230708-2
...
(function (global, factory) {
    ...
    const typeGuard = {
        ...
        ReturnStatement: (i) => !!i && typeof i === "object" && i.type === "ReturnStatement",
    ...
    const processDistance = (script, scopes, _, trace) => {
        ...
        return Math.sqrt(Math.pow(Number(args.x2) - Number(args.x1), 2) +
    ...
    const processDump = (script, scopes, _object, trace) => {
        for (const argument of script.arguments) {
            console.debug("%cdump", "background:green;", execute$1(argument, scopes, trace), trace);
        }
    };
    ...
    const processCallExpression = (script, scopes, trace) => {
        ...
        if (object?.[callee] &&
            object?.[callee]?.type === "definedFunction") {
            const func = object[callee];
            if (func.isKari) {
                const args = {};
                let count = 1;
                script.arguments.forEach((val) => {
                    if (val?.NIWANGO_Identifier) {
                        args[getName$1(val.NIWANGO_Identifier, scopes, trace)] =
                            execute$1(val, scopes, trace);
                    }
                    else {
                ...
                return execute$1(func.script.arguments[1], [{ ...args, self: object }, object, ...scopes], trace);
            }
        }
        const self = resolve({ type: "Identifier", name: "self" }, scopes, trace);
        if (self?.[callee] &&
            self?.[callee]?.type === "definedFunction") {
            const func = self[callee];
            if (func.isKari) {
                const args = {};
                let count = 1;
                script.arguments.forEach((val) => {
    ...
    const processRaw$3 = (script) => {
        return script.value;
    };

    const processReturnStatement = (script, scopes, trace) => {
        return execute$1(script.argument, scopes, trace);
    };
    ...
    const execute = (script, scopes, trace) => {
    ...
    const processProduct = (_script, _scopes, object) => {
        return object.reduce((pv, val) => pv * Number(val), 1);
    };
    ...
    const processSum = (_script, _scopes, object) => {
        return object.reduce((pv, val) => pv + Number(val), 0);
    };
    ...
    (function (module) {
      ...
      (function (root, factory) {
        ...
        function peg$parse(input, options) {
          ...
          var peg$f35 = function peg$f35(expression) {
            return expression;
          };
          var peg$f36 = function peg$f36(elision) {
            return {
              type: "ArrayExpression",
              elements: optionalList(extractOptional(elision, 0))
            };
          };
          var peg$f37 = function peg$f37(elements) {
            return {
              type: "ArrayExpression",
              elements: elements
            };
          };
          var peg$f38 = function peg$f38(elements, elision) {
            return {
              type: "ArrayExpression",
              elements: elements.concat(optionalList(extractOptional(elision, 0)))
            };
          };
          var peg$f39 = function peg$f39(elision, element) {
            return optionalList(extractOptional(elision, 0)).concat(element);
          };
          var peg$f40 = function peg$f40(head, elision, element) {
            return optionalList(extractOptional(elision, 0)).concat(element);
          };
          var peg$f41 = function peg$f41(head, tail) {
            return Array.prototype.concat.apply(head, tail);
          };
          var peg$f42 = function peg$f42(commas) {
            return filledArray(commas.length + 1, null);
          };
          var peg$f43 = function peg$f43() {
            return {
          ...
          var peg$f45 = function peg$f45(properties) {
            return {
              type: "ObjectExpression",
              properties: properties
            };
          };
          var peg$f46 = function peg$f46(head, tail) {
            return buildList(head, tail, 3);
          };
          var peg$f47 = function peg$f47(key, value) {
            return {
              type: "Property",
              key: key,
              value: value,
          ...
          var peg$f48 = function peg$f48(key, body) {
            return {
              type: "Property",
              key: key,
              value: {
          ...
          var peg$f49 = function peg$f49(key, params, body) {
            return {
              type: "Property",
              key: key,
              value: {
          ...
          var peg$f50 = function peg$f50(id) {
            return [id];
          };
          var peg$f51 = function peg$f51(value) {
            return {
              type: "Literal",
              value: Number(value)
            };
          ...
          var peg$f53 = function peg$f53(head, property) {
            return {
              property: property,
              computed: true
            };
          ...
          var peg$f55 = function peg$f55(head, tail) {
          ...
          var peg$f56 = function peg$f56(callee) {
            return {
              type: "NewExpression",
              callee: callee,
              arguments: []
          ...
          var peg$f57 = function peg$f57(callee, args) {
            return {
              type: "CallExpression",
              callee: callee,
              arguments: args
          ...
          var peg$f58 = function peg$f58(head, args) {
            return {
              type: "CallExpression",
              arguments: args
            };
          };
          var peg$f59 = function peg$f59(head, property) {
            return {
              type: "MemberExpression",
              property: property,
              computed: true
          ...
          var peg$f60 = function peg$f60(head, property) {
            return {
              type: "MemberExpression",
              property: property,
              computed: false
          ...
          var peg$f61 = function peg$f61(head, tail) {
            return tail.reduce(function (result, element) {
              element[TYPES_TO_PROPERTY_NAMES[element.type]] = result;
              return element;
            }, head);
          };
          var peg$f62 = function peg$f62(args) {
            return optionalList(extractOptional(args, 0));
          };
          var peg$f63 = function peg$f63(head, tail) {
            return buildList(head, tail, 3);
          };
          var peg$f64 = function peg$f64(identifier, argument) {
          ...
          var peg$f66 = function peg$f66(identifier) {
            return identifier;
          };
          var peg$f67 = function peg$f67(argument, operator) {
            return {
          ...
          var peg$f68 = function peg$f68(operator, argument) {
          ...
          var peg$f70 = function peg$f70(head, tail) {
            return buildBinaryExpression(head, tail);
          };
          var peg$f71 = function peg$f71(head, tail) {
            return buildBinaryExpression(head, tail);
          };
          var peg$f72 = function peg$f72(head, tail) {
            return buildBinaryExpression(head, tail);
          };
          var peg$f74 = function peg$f74(head, tail) {
            return buildBinaryExpression(head, tail);
          };
          var peg$f76 = function peg$f76(head, tail) {
            return buildBinaryExpression(head, tail);
          };
          var peg$f78 = function peg$f78(head, tail) {
            return buildBinaryExpression(head, tail);
          };
          var peg$f80 = function peg$f80(head, tail) {
            return buildBinaryExpression(head, tail);
          };
          var peg$f82 = function peg$f82(head, tail) {
            return buildLogicalExpression(head, tail);
          };
          var peg$f84 = function peg$f84(head, tail) {
            return buildLogicalExpression(head, tail);
          };
          var peg$f86 = function peg$f86(test, consequent, alternate) {
            return {
          ...
          var peg$f88 = function peg$f88(left, right) {
            return {
          ...
          var peg$f89 = function peg$f89(left, right) {
            return {
          ...
          var peg$f90 = function peg$f90(left, operator, right) {
            return {
              type: "AssignmentExpression",
              operator: operator,
              left: left,
          ...
          var peg$f93 = function peg$f93(head, tail) {
            return tail.length > 0 ? {
              type: "SequenceExpression",
              expressions: buildList(head, tail, 3)
            } : head;
          };
          var peg$f95 = function peg$f95(body) {
            return {
              type: "BlockStatement",
              __type: "Block1",
          ...
          var peg$f96 = function peg$f96(body) {
            return {
              type: "BlockStatement",
              __type: "Block2",
              body: optionalList(extractOptional(body, 0))
          ...
          var peg$f97 = function peg$f97(head, tail) {
            return buildList(head, tail, 1);
          };
          var peg$f98 = function peg$f98(declarations) {
            return {
              type: "VariableDeclaration",
          ...
          var peg$f99 = function peg$f99(head, tail) {
            return buildList(head, tail, 3);
          };
          var peg$f101 = function peg$f101(id, init) {
            return {
              type: "VariableDeclarator",
              id: id,
          ...
          var peg$f103 = function peg$f103(expression) {
            return expression;
          };
          var peg$f105 = function peg$f105() {
            return {
              type: "EmptyStatement"
            };
          };
          var peg$f106 = function peg$f106(expression) {
            return {
          ...
          var peg$f108 = function peg$f108(label) {
            return {
              type: "ContinueStatement",
              label: label
            };
          };
          var peg$f109 = function peg$f109() {
            return {
              type: "BreakStatement",
              label: null
            };
          };
          var peg$f110 = function peg$f110(label) {
            return {
              type: "BreakStatement",
              label: label
            };
          };
          var peg$f111 = function peg$f111() {
            return {
              type: "ReturnStatement",
              argument: null
            };
          };
          var peg$f112 = function peg$f112(argument) {
            return {
              type: "ReturnStatement",
              argument: argument
            };
          };
          var peg$f113 = function peg$f113(object, body) {
            return {
              type: "WithStatement",
              object: object,
              body: body
          ...
          var peg$f119 = function peg$f119(label, body) {
            return {
          ...
          var peg$f120 = function peg$f120(argument) {
            return {
              type: "ThrowStatement",
              argument: argument
            };
          };
          var peg$f121 = function peg$f121(block, handler, finalizer) {
            return {
              type: "TryStatement",
              block: block,
              handler: handler,
          ...
          var peg$f122 = function peg$f122(block, handler) {
            return {
              type: "TryStatement",
              block: block,
              handler: handler,
          ...
          var peg$f123 = function peg$f123(block, finalizer) {
            return {
              type: "TryStatement",
              block: block,
              handler: null,
          ...
          var peg$f124 = function peg$f124(param, body) {
            return {
              type: "CatchClause",
              param: param,
              body: body
          ...
          var peg$f125 = function peg$f125(block) {
            return block;
          };
          var peg$f126 = function peg$f126() {
            return {
              type: "DebuggerStatement"
            };
          };
          var peg$f127 = function peg$f127(id, params, body) {
            return {
          ...
          var peg$f128 = function peg$f128(id, params, body) {
            return {
              type: "FunctionExpression",
          ...
          var peg$f129 = function peg$f129(body) {
            return {
              type: "LambdaExpression",
              body: body
            };
          };
          var peg$f130 = function peg$f130(body) {
            return {
              type: "LambdaExpression",
              body: body
            };
          };
          var peg$f131 = function peg$f131(body) {
            return {
              type: "LambdaExpression",
              body: body
            };
          };
          var peg$f132 = function peg$f132(head, tail) {
            return buildList(head, tail, 3);
          };
          var peg$f133 = function peg$f133(body) {
            return {
              type: "BlockStatement",
              __type: "FunctionBody",
          ...
          var peg$f134 = function peg$f134(body) {
            return {
              type: "Program",
              body: optionalList(body)
            };
          };
          var peg$f135 = function peg$f135(head, tail) {
            return buildList(head, tail, 1);
          };
          var peg$currPos = 0;
          var peg$savedPos = 0;
          ...
          function peg$parsePropertyAssignment() {
            var s0, s1, s3, s5, s7, s9, s11, s13, s15;
          ...
          function peg$parseFunctionDeclaration() {
            var s0, s1, s3, s5, s7, s8, s9, s10, s12, s14;
    ...
    const processSlice = (script, scopes, object, trace) => {
        ...
        if (typeof length !== "undefined") {
            return object.slice(Number(startIndex), Number(startIndex) + Number(length));
        }
    ...
    const processAnd = (script, scopes, object, trace) => {
        const toASBoolean = resolvePrototype$1(getType(object), "toASBoolean");
        if (!toASBoolean)
            throw new Error();
    ...
    const processMinus = (script, scopes, object, trace) => {
        const toASNumber = resolvePrototype$1(getType(object), "toASNumber");
        if (!toASNumber)
            throw new Error();
    ...
    const processNot = (script, scopes, object, trace) => {
        const toASBoolean = resolvePrototype$1(getType(object), "toASBoolean");
        if (!toASBoolean)
            throw new Error();
    ...
    const processPlus = (script, scopes, object, trace) => {
        const toASNumber = resolvePrototype$1(getType(object), "toASNumber");
        if (!toASNumber)
            throw new Error();
